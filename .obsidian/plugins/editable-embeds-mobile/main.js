...
class EditableEmbedsMobilePlugin extends obsidian.Plugin {
	settings;
	styleEl = null;
	...
	makeEditable(embedEl, sourcePath) {
	...
	async openFileInEditor(file, src) {
	...
	async editEmbed(embedEl, file, src) {
...
class EditableEmbedsSettingTab extends obsidian.PluginSettingTab {
	plugin;
...
module.exports = EditableEmbedsMobilePlugin;
