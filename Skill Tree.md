...
if (!document.getElementById('skill-tree-styles-v2')) {
    ...
    style.textContent = `
        * { -webkit-tap-highlight-color: transparent; }
        ...
        .skill-fullscreen-toggle:hover {
            background: rgba(0, 0, 0, 0.9);
            border-color: #555;
            color: #fff;
        }

        .skill-fullscreen-toggle svg {
            width: 16px;
            height: 16px;
            transition: transform 0.3s ease;
        }

        .skill-tree-container.minimized .skill-fullscreen-toggle svg {
...
fullscreenToggle.className = 'skill-fullscreen-toggle';
...
mainContainer.appendChild(fullscreenToggle);
